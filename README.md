...
The comment rules are intentionally absent from broad selectors because agent sessions, human editing, and commit gates need different enforcement. Put the policy in a supported RC, YAML, or TOML file and select the rules directly by code or name.
